...
class CargaProductosProg(ctk.CTkFrame):
    ...
    # MENU LINEAS
        ...
        self.lin_menu = ctk.CTkOptionMenu(entry_frame,
                                     values=self.lineas,
                                     command=self.SelectLinMenu)
        self.lin_menu.grid(row=4,column=0,columnspan=2,sticky='we',padx=5)
    # MENU GRUPO
    ...
    # MENU PROVEEDORES
        self.prov_menu = ctk.CTkOptionMenu(entry_frame,
                                      values=PROV_MANAGER.GetProvNames(),
                                      command=self.SelectProvMenu)
        self.prov_menu.grid(row=6,column=0,columnspan=2,sticky='we',padx=5)
    ...
    # ACTUALIZAR
        actualizar_btn = ctk.CTkButton(tree_frame,
                                       text='Actualizar',
                                       command=self.Actualizar,
                                       fg_color=APP_COLORS[2],
                                       hover_color=APP_COLORS[3])
        actualizar_btn.grid(row=0,column=0,sticky='w',padx=5)
    # TREEVIEW
